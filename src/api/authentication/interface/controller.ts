...
export class AuthController extends BaseController {
  ...
  async refresh(req: Request, res: Response, next: NextFunction) {
    ...
    const serviceResponse = await this.authService.findUserByRefreshToken(refreshToken);
  ...
  async login(req: Request, res: Response, next: NextFunction) {
    const authenticateResponse = await this.authService.authenticateUser(req.body);
  ...
  public async createNewUser(req: Request, res: Response, next: NextFunction) {
    ...
    const serviceResponse = await this.authService.createNewUser(newUserDetails);
